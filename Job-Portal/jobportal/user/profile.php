          ...
          <form method="post" action="updateprofile.php">
            ...
            ?>
               <div class="form-group">
                  ...
                  <input type="name" class="form-control" id="fname" name="fname" placeholder="Enter Your first Name" value="<?php echo $row['firstname']; ?>" required="">
               </div>
               <div class="form-group">
                  <label for="lastname">LastName</label>
                  <input type="name" class="form-control" id="lname" name="lname" placeholder="Enter Your last Name" value="<?php echo $row['lastname']; ?>" required="">
               </div>
               <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <textarea id="address" name="address" class="form-control" rows="5" placeholder="Enter Your Address" value="<?php echo $row['address']; ?>"></textarea>             
               </div>
               <div class="form-group">
                  <label for="city">City</label>

                  <input type="text" class="form-control" id="city" name="city" placeholder="City Name" value="<?php echo $row['city']; ?>">
              </div>
              <div class="form-group">
                  <label for="state">State</label>
                  <input type="text" class="form-control" id="state" name="state" placeholder="state name" value="<?php echo $row['state']; ?>" >
              </div>
              <div class="form-group">
                  <label for="contactno">Contact Number</label>
                  <input type="text" class="form-control" id="contactno" name="contactno" placeholder="phone number" value="<?php echo $row['qualification']; ?>">
              </div>
              <div class="form-group">
