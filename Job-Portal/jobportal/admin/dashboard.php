    ...
    <div class="container-fluid" style="margin-top: 50px;">
      <div class="row">
        <div class="col-md-4">
          <div class="list-group">
           ...
           <a href="job-posts.php" class="list-group-item ">Job Post</a>
          </div>
      ...
      <div class="col-md-6">
        <?php
              ...
              {
                echo '<h3> Total Pending Account: ' . $result->num_rows . '</h3>';
              }
              ...
              if($result->num_rows > 0)
              {
                ...
                while($row = $result->fetch_assoc())
                {
                  ...
                  <tr>
                    ...
                    <td><a href="reject-company.php?id=<?php echo $row['id_company']; ?>">Reject</a></td>
                     <td><a href="approve-company.php?id=<?php echo $row['id_company']; ?>">Approve</a></td>
                  </tr>
                  <?php
                }
              }
